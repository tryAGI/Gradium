...
namespace Gradium
{
    public partial class PronunciationsClient
    {
        ...
        {
            var __response = await UpdatePronunciationDictionaryPronunciationsUidPutAsResponseAsync(
                uid: uid,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Gradium.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Gradium.AutoSDKHttpResponse<global::Gradium.PronunciationDictionaryResponse>> UpdatePronunciationDictionaryPronunciationsUidPutAsResponseAsync(
            string uid,
