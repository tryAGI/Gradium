...
namespace Gradium
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Gradium.AutoSDKRetryOptions Retry { get; set; } = new global::Gradium.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Gradium.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Gradium.IAutoSDKHook>();
        ...
        public global::Gradium.AutoSDKClientOptions AddHook(
            global::Gradium.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Gradium.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Gradium.AutoSDKClientOptions UseAuthorizationProvider(
            global::Gradium.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Gradium.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Gradium.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Gradium.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Gradium.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Gradium.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Gradium.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Gradium.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Gradium.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Gradium.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Gradium.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Gradium.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Gradium.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Gradium.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Gradium.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Gradium.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Gradium.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Gradium.AutoSDKClientOptions clientOptions,
            global::Gradium.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Gradium.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Gradium.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Gradium.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Gradium.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Gradium.IAutoSDKHook, global::Gradium.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Gradium.AutoSDKHookContext context)
        {
