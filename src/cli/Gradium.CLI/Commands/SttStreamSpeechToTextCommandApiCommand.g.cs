...
- `json_config` (object or string, required): STT settings, for example `{""language"":""en"",""delay_in_frames"":16}`. `language` is required; set it to (`en`, `fr`, `es`, `pt`, `de`, or `any` to auto-detect).
