...
{
    private const string UserSecretsId = "Gradium.CLI";
    private const string UserSecretApiKeyName = "GRADIUM_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"GRADIUM_API_KEY"];
    private const string CredentialFileDirectoryName = ".gradium";

    public static async global::System.Threading.Tasks.Task<global::Gradium.GradiumClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Gradium.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Gradium.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "ApiKey",
        ...
        return new global::Gradium.GradiumClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Gradium.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Gradium.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Gradium.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::Gradium.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("GRADIUM_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Gradium.ApiException exception)
    {
        var builder = new StringBuilder();
