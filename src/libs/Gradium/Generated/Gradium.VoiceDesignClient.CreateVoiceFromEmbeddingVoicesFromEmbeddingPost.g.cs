...
namespace Gradium
{
    public partial class VoiceDesignClient
    {


        private static readonly global::Gradium.EndPointSecurityRequirement s_CreateVoiceFromEmbeddingVoicesFromEmbeddingPostSecurityRequirement0 =
        ...
        private static readonly global::Gradium.EndPointSecurityRequirement[] s_CreateVoiceFromEmbeddingVoicesFromEmbeddingPostSecurityRequirements =
            new global::Gradium.EndPointSecurityRequirement[]
            {                s_CreateVoiceFromEmbeddingVoicesFromEmbeddingPostSecurityRequirement0,
            };
        partial void PrepareCreateVoiceFromEmbeddingVoicesFromEmbeddingPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Gradium.VoiceFromEmbeddingCreate request);
        partial void PrepareCreateVoiceFromEmbeddingVoicesFromEmbeddingPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Gradium.VoiceFromEmbeddingCreate request);
        partial void ProcessCreateVoiceFromEmbeddingVoicesFromEmbeddingPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateVoiceFromEmbeddingVoicesFromEmbeddingPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Gradium.VoiceFromEmbeddingResponse> CreateVoiceFromEmbeddingVoicesFromEmbeddingPostAsync(

            global::Gradium.VoiceFromEmbeddingCreate request,
            global::Gradium.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateVoiceFromEmbeddingVoicesFromEmbeddingPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Gradium.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Gradium.AutoSDKHttpResponse<global::Gradium.VoiceFromEmbeddingResponse>> CreateVoiceFromEmbeddingVoicesFromEmbeddingPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateVoiceFromEmbeddingVoicesFromEmbeddingPostArguments(
            ...
            var __authorizations = global::Gradium.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateVoiceFromEmbeddingVoicesFromEmbeddingPostSecurityRequirements,
                operationName: "CreateVoiceFromEmbeddingVoicesFromEmbeddingPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateVoiceFromEmbeddingVoicesFromEmbeddingPostRequest(
                    httpClient: HttpClient,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Gradium.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Gradium.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateVoiceFromEmbeddingVoicesFromEmbeddingPost",
                                methodName: "CreateVoiceFromEmbeddingVoicesFromEmbeddingPostAsync",
                                pathTemplate: "\"/voices/from-embedding\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Gradium.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateVoiceFromEmbeddingVoicesFromEmbeddingPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Gradium.VoiceFromEmbeddingResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Gradium.AutoSDKHttpResponse<global::Gradium.VoiceFromEmbeddingResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Gradium.VoiceFromEmbeddingResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Gradium.VoiceFromEmbeddingResponse> CreateVoiceFromEmbeddingVoicesFromEmbeddingPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Gradium.VoiceFromEmbeddingCreate
            {
            ...
            return await CreateVoiceFromEmbeddingVoicesFromEmbeddingPostAsync(
                request: __request,
                requestOptions: requestOptions,
