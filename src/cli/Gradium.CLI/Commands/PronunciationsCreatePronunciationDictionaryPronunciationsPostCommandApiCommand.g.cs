...
internal static partial class PronunciationsCreatePronunciationDictionaryPronunciationsPostCommandApiCommand
{
...
Create a pronunciation dictionary for the authenticated organization.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::Gradium.PronunciationDictionaryCreate>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Pronunciations.CreatePronunciationDictionaryPronunciationsPostAsync(
                                    name: name,
