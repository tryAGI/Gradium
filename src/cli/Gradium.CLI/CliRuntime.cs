...
internal static class CliRuntime
{
    ...
    public static async Task<global::Gradium.GradiumClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::Gradium.ApiException exception)
    {
        var builder = new StringBuilder();
