...
The Gradium SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package Gradium
```
...
using var client = new GradiumClient(
    apiKey: Environment.GetEnvironmentVariable("GRADIUM_API_KEY")!);
