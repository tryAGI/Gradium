...
namespace Gradium
{
    public partial class VoicesClient
    {
        ...
        private static readonly global::Gradium.EndPointSecurityRequirement s_UpdateVoiceVoicesVoiceUidPutSecurityRequirement0 =
        ...
        private static readonly global::Gradium.EndPointSecurityRequirement[] s_UpdateVoiceVoicesVoiceUidPutSecurityRequirements =
            new global::Gradium.EndPointSecurityRequirement[]
            {                s_UpdateVoiceVoicesVoiceUidPutSecurityRequirement0,
            };
        partial void PrepareUpdateVoiceVoicesVoiceUidPutArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string voiceUid,
            global::Gradium.VoiceUpdate request);
        partial void PrepareUpdateVoiceVoicesVoiceUidPutRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string voiceUid,
            global::Gradium.VoiceUpdate request);
        partial void ProcessUpdateVoiceVoicesVoiceUidPutResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateVoiceVoicesVoiceUidPutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Gradium.VoiceResponse> UpdateVoiceVoicesVoiceUidPutAsync(
            string voiceUid,
        ...
        {
            var __response = await UpdateVoiceVoicesVoiceUidPutAsResponseAsync(
                voiceUid: voiceUid,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Gradium.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Gradium.AutoSDKHttpResponse<global::Gradium.VoiceResponse>> UpdateVoiceVoicesVoiceUidPutAsResponseAsync(
            string voiceUid,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateVoiceVoicesVoiceUidPutArguments(
                httpClient: HttpClient,
                voiceUid: ref voiceUid,
                request: request);


            var __authorizations = global::Gradium.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_UpdateVoiceVoicesVoiceUidPutSecurityRequirements,
                operationName: "UpdateVoiceVoicesVoiceUidPutAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateVoiceVoicesVoiceUidPutRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Gradium.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Gradium.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpdateVoiceVoicesVoiceUidPut",
                                methodName: "UpdateVoiceVoicesVoiceUidPutAsync",
                                pathTemplate: "$\"/voices/{voiceUid}\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateVoiceVoicesVoiceUidPutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Gradium.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateVoiceVoicesVoiceUidPutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Gradium.VoiceResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Gradium.AutoSDKHttpResponse<global::Gradium.VoiceResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Gradium.VoiceResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Gradium.VoiceResponse> UpdateVoiceVoicesVoiceUidPutAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Gradium.VoiceUpdate
            {
                Name = name,
            ...
            return await UpdateVoiceVoicesVoiceUidPutAsync(
                voiceUid: voiceUid,
                request: __request,
                requestOptions: requestOptions,
